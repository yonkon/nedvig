...
$dictionary["sphr_client_sphr_inspection_tour"] = array (
  ...
  'table' => 'sphr_clientpection_tour_c',
  'fields' => 
  array (
    0 => 
    array (
    ...
    4 => 
    array (
      'name' => 'sphr_clien26ebon_tour_idb',
      'type' => 'varchar',
      'len' => 36,
    ),
  ),
  ...
  array (
    0 => 
    array (
      'name' => 'sphr_clientnspection_tourspk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    1 => 
    array (
      'name' => 'sphr_clientnspection_tour_ida1',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'sphr_clien6152_client_ida',
      ),
    ),
    2 => 
    array (
      'name' => 'sphr_clientnspection_tour_alt',
      'type' => 'alternate_key',
      'fields' => 
      array (
        0 => 'sphr_clien26ebon_tour_idb',
      ),
    ),
  ),
);
