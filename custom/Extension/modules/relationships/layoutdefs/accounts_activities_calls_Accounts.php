...
$layout_defs["Accounts"]["subpanel_setup"]["activities"] = array (
  ...
  array (
    ...
    array (
      ...
      'get_subpanel_data' => 'accounts_activities_meetings',
    ),
    'tasks' => 
    array (
      'module' => 'Tasks',
      'subpanel_name' => 'ForActivities',
      'get_subpanel_data' => 'accounts_activities_tasks',
    ),
    'calls' => 
    array (
      'module' => 'Calls',
      'subpanel_name' => 'ForActivities',
      'get_subpanel_data' => 'accounts_activities_calls',
    ),
  ),
...
$layout_defs["Accounts"]["subpanel_setup"]["history"] = array (
  ...
  array (
    ...
    array (
      'module' => 'Notes',
      'subpanel_name' => 'ForHistory',
      'get_subpanel_data' => 'accounts_activities_notes',
    ),
    'emails' => 
    array (
      'module' => 'Emails',
      'subpanel_name' => 'ForHistory',
      'get_subpanel_data' => 'accounts_activities_emails',
    ),
  ),
