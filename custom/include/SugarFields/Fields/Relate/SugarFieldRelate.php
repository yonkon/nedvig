...
class SugarFieldRelate extends SugarFieldBase {
    ...
    function getDetailViewSmarty($parentFieldArray, $vardef, $displayParams, $tabindex) {
        ...
        return $this->fetch('custom/include/SugarFields/Fields/Relate/DetailView.tpl');
    }
    ...
    function getEditViewSmarty($parentFieldArray, $vardef, $displayParams, $tabindex) {
        ...
        //form fields into.
         if(isset($vardef['module']) && preg_match('/Accounts/si',$vardef['module'])){
            $vardef['agent_module'] = trim($_REQUEST['module']);
            $vardef['module_id'] =  trim($_REQUEST['record']);
           }
        if(isset($vardef['module']) && preg_match('/Accounts/si',$vardef['module'])
        ...
        $this->setup($parentFieldArray, $vardef, $displayParams, $tabindex);
        return $this->fetch('custom/include/SugarFields/Fields/Relate/EditView.tpl');
    }
    ...
    function getSearchViewSmarty($parentFieldArray, $vardef, $displayParams, $tabindex) {
        ...
        $this->setup($parentFieldArray, $vardef, $displayParams, $tabindex);
        return $this->fetch('custom/include/SugarFields/Fields/Relate/SearchView.tpl');
    }
