...
{	
	$('.asterisk_phoneNumber').each(function()
	{
		...
		if(phoneNr.length > 1)
		{
			...
			$(this).append('&nbsp;&nbsp;<img src="custom/modules/Asterisk/include/call_active.gif" class="asterisk_placeCall" value="anrufen" style="cursor: pointer;"/> ');	
			
			$('.asterisk_placeCall', this).click(function()
			{
				// alert("phoneNr : "+phoneNr+" , contactId: "+contactId);
				var call = $.get('custom/modules/Asterisk/include/callCreate.php', 
