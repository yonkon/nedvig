...
// $hook_array['after_ui_frame'][] = Array(1, 'Asterisk', 'custom/modules/Asterisk/include/AsteriskJS.php','AsteriskJS', 'echoJavaScript'); 
...
$hook_array['after_ui_footer'][] = Array(10, 'echoJavaScript', 'modules/k3_feedback/hooks.php','k3_feedback_hooks', 'echoJavaScript'); 
