          ...
          array(
          	'customCode' => '<script>
                             jQuery(function($){ldelim}
            				    		$("input#sphr_clientb_queries_name").attr("value","{$smarty.request.sphr_client_cosib_queries_name}");
            				    		$("input#sphr_clien735b_client_ida").attr("value","{$smarty.request.sphr_client_id}");
            				    		$("input#type_of_object_relate_c").attr("value","{$smarty.request.sphr_object_name}");
            				    		$("input#sphr_object_id_c").attr("value","{$smarty.request.sphr_object_id}");
            				    		$("input#accounts_cob_queries_name").attr("value","{$smarty.request.accounts_cosib_queries_name}");
            				    		$("input#accounts_c3c3bccounts_ida").attr("value","{$smarty.request.account_id}");
	            				    {rdelim});
          					</script>',
          ...
          array (
            ...
            'label' => 'LBL_ACCOUNTS_AGENTS',
             'customCode' => '
						...
						{literal}<script>'.file_get_contents('custom/modules/Accounts/javascript/relate_field_agents.js').'</script>{/literal}
						<script>
