...
if (!defined('K_TCPDF_EXTERNAL_CONFIG')) {
    ...
    /**
     * image logo for the default Header and Footer
     */
    defineFromConfig("PDF_HEADER_LOGO", $sugarpdf_default["PDF_HEADER_LOGO"]);
    defineFromConfig("PDF_FOOTER_LOGO", $sugarpdf_default["PDF_FOOTER_LOGO"]);
    /**
     * header logo image width [mm]
     */
    defineFromConfig("PDF_HEADER_LOGO_WIDTH", $sugarpdf_default["PDF_HEADER_LOGO_WIDTH"]);
    defineFromConfig("PDF_FOOTER_LOGO_WIDTH", $sugarpdf_default["PDF_FOOTER_LOGO_WIDTH"]);
        /**
