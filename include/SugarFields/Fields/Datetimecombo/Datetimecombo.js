...
this.fieldname=field;this.hrs=parseInt(datetime.substring(11,13),10);this.mins=parseInt(datetime.substring(14,16),10);if(this.mins>0&&this.mins<5){this.mins=5;}else if(this.mins>5&&this.mins<10){this.mins=10;}else if(this.mins>10&&this.mins<15){this.mins=15;}else if(this.mins>15&&this.mins<20){this.mins=20;}else if(this.mins>20&&this.mins<25){this.mins=25;}else if(this.mins>25&&this.mins<30){this.mins=30;}else if(this.mins>30&&this.mins<35){this.mins=35;}else if(this.mins>35&&this.mins<40){this.mins=40;}else if(this.mins>40&&this.mins<45){this.mins=45;}else if(this.mins>45&&this.mins<50){this.mins=50;}else if(this.mins>50&&this.mins<55){this.mins=55;}else if(this.mins>55){this.hrs+=1;this.mins=0;}
