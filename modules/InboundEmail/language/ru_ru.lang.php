...
'LNK_LIST_CREATE_NEW_GROUP'	 => 'Создать групповую учетную запись',
'LNK_LIST_CREATE_NEW_BOUNCE' => 'Создать учетную запись для обработки возвращаемой почты',
...
'LBL_IS_PERSONAL' => 'Индивидуальный почтовый ящик',
...
'LBL_ALLOW_OUTBOUND_GROUP_USAGE_DESC' => 'Имя и адрес групповой учетной записи появятся в поле <<b>От</b>> при отправке писем пользователям, являющимся членами данной групповой учетной записи.',
