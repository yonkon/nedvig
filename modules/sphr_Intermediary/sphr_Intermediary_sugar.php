 ...
 * PLACE ANY CUSTOMIZATIONS IN sphr_Intermediary
 */

require_once('include/SugarObjects/templates/person/Person.php');

class sphr_Intermediary_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'sphr_Intermediary';
	var $object_name = 'sphr_Intermediary';
	var $table_name = 'sphr_intermediary';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $email_addresses;
		var $first_and_middle_nme;
		var $email;
		var $source;
		var $status;
		function sphr_Intermediary_sugar(){	
		parent::Person();
	}
