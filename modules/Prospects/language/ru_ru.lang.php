...
'LBL_PROSPECT_INFORMATION' => 'Описание адресата',
...
'MSG_SHOW_DUPLICATES' => 'Создаваемый вами адресат возможно дублирует уже имеющуюся запись. Адресаты со схожими названиями и/или адресами электронной почты показаны ниже. Нажмите кнопку "Сохранить"  для продолжения создания нового адресата или кнопку "Отказаться" для возврата в модуль.' ,
