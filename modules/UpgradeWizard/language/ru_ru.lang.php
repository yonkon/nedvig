...
'ERR_UW_MYSQL_VERSION'=> 'Необходима MySQL версии 4.1.2 или выше. Обнаружено: ',
	...
	'LBL_UW_END_LOGOUT' => 'Если вы планируете установить еще один пакет обновления - выйдите и войдите в систему заново.',
	...
	'LBL_UW_PREFLIGHT_TESTS_PASSED3'=> '<i><b>Примечание: </b></i>Оставшаяся часть процесса обновления является обязательной. Нажмите на кнопку <b>Вперед</b> для завершения процесса обновления или нажмите на кнопку <b>Отмена</b> для остановки работы мастера обновления.',	
