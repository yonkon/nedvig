...
$mod_strings = array (
    ...
    'LBL_CHANGE_NAME_TABS'=>'Редактирование меток закладок' ,
	...
	'LBL_CONFIG_TABS'=>'Выбор закладок модулей и субпанелей',
    ...
    'LBL_DIAGNOSTIC_GETMD5INFO' => 'Подсчет контрольных сумм (MD5)...',
    'LBL_DIAGNOSTIC_GETMYSQLINFO' => 'основной информации о БД',
    'LBL_DIAGNOSTIC_GETMYSQLTD' => 'дампа таблиц',
    'LBL_DIAGNOSTIC_GETMYSQLTS' => 'схемы таблиц',
    ...
    'LBL_DIAGNOSTIC_MYSQLDUMPS'=>'MySQL - Дамп таблиц с данными о конфигурации системы',
    'LBL_DIAGNOSTIC_MYSQLINFO'=>'MySQL - Основная информация',
    'LBL_DIAGNOSTIC_MYSQLSCHEMA'=>'MySQL - Структура таблиц',
    ...
    'LBL_MASS_EMAIL_MANAGER_DESC'=> 'Управление очередностью рассылки исходящей почты' ,
	...
	'LBL_PASSWORD_SYST_GENERATED_PWD_HELP' => 'Когда данная опция включена, пользователям будет высылаться письмо, содержащее  автоматически сгенерированную ссылку. Открыв данную ссылку пользователь попадет на страницу, где сможет ввести новое значение пароля. Для работы этой опции необходимо следующее: 1) В настройках E-mail должен быть корректно настроен сервер исходящей почты.<br>2) Учетные записи пользователей должны содержать корректную информацию об их электронных адресах.',
    ...
    'LBL_REPAIR_DATABASE_TEXT' => 'Это средство позволяет обновить БД в соответствии с изменениями, сделанными в vardefs и в связанных метаданных. <br><br>Вы можете выбрать одно из трех действий:<br><br>Показ SQL   - отображение на экране запроса, который будет выполнен<br>Экспорт SQL   - экспорт запроса в файл<br>Запуск SQL   - выполнение запроса.<br><br><strong><u>Примечание:</u> любые изменения скрипта не будут учитываться при экспортировании или выполнении кода.' ,
    ...
    'LBL_REPAIR_INDEX_DESC'=>'Проверка и (по возможности) восстановление индексов базы данных согласно данным, содержащимся в файлах vardef',
    ...
    'LBL_TRACKER_SETTINGS_DESC' => 'Выбор системных и пользовательских данных для отслеживания',
    ...
    'WARN_REPAIR_CONFIG' => 'Предупреждение: Файл config.php должен быть восстановлен. В панели администратора перейдите по ссылке  "<a href=\'index.php?module=Administration&action=RebuildConfig\'>Восстановление файла конфигурации</a>".' , 
    ...
    'LBL_QR_CLEARALL'=> 'Полная очистка кэша...готово',
   ...
   'LBL_SAML_LOGIN_URL_DESC' => 'Введите SAML URL для аутентификации'
