...
'LBL_ALT_ADDRESS_STREET_2' => 'Дополнительный адрес - улица 2:' ,
'LBL_ALT_ADDRESS_STREET_3' => 'Дополнительный адрес - улица 3:' ,
...
'LBL_DIRECT_REPORTS_SUBPANEL_TITLE' => 'Подчиненные' ,
...
'MSG_DUPLICATE' => 'Создаваемый вами контакт возможно дублирует уже имеющуюся запись. Контакты, содержащие схожие имена и/или схожие адреса электронной почты показаны ниже. Нажмите кнопку "Сохранить"  для продолжения создания нового контакта или кнопку "Отказаться" для возврата в модуль.' ,
'MSG_SHOW_DUPLICATES' => 'Создаваемый вами контакт возможно дублирует уже имеющуюся запись. Контакты, содержащие схожие имена и/или схожие адреса электронной почты показаны ниже. Нажмите кнопку "Сохранить"  для продолжения создания нового контакта или кнопку "Отказаться" для возврата в модуль.',
...
'LBL_COPY_ADDRESS_CHECKED' => 'Копирование адреса для отмеченных контактов' ,
