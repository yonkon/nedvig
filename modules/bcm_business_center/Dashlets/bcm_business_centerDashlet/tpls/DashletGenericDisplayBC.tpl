...
<a href="index.php?module=bcm_business_center&action=EditView&return_module=bcm_business_center&return_action=DetailView">Добавить новый Бизнес-центр</a><br>
