...
'LBL_EMAILS_SPHR_CLIENT_REL' => 'E-mail: Клиенты' ,
...
'LBL_BUTTON_DISTRIBUTE_TITLE' => 'Назначение [Alt+A]' ,
...
'LBL_ADD_CC_BCC_SEP' => '|',
//'LBL_SEND_EMAIL_FAIL' => 'Система не смогла отправить письмо, используя настройки сервера исходящей почты текущей учетной записи. Проверьте настройки сервера исходящей почты в параметрах E-mail или используйте другую учетную запись.',
'LBL_SEND_EMAIL_FAIL_TITLE' => 'Ошибка отправки Е-mail',
//'LBL_OPENSSL_EXTENSION_NOT_OPEN'=>'Расширение php_openssl не установлено. Свяжитесь с системным администратором.',
...
'LBL_EMAIL_INBOUND_TYPE_HELP' => '<b>Персональная</b>: Ваша учетная запись. Только вы можете работать с письмами этой учетной записи.<br><b>Групповая</b>: Групповая учетная запись. Все участники группы могут работать с письмами этой учетной записи.<br><b>Групповая-автоимпорт</b>: Групповая учетная запись. Письма данной учетной записи автоматически импортируются в систему.',
