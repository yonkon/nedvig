...
$mod_strings = array (
'LBL_DELETE_USER_CONFIRM' => 'При удалении пользователя будет также удален соответствующий сотрудник.<br/><br/> Нажмите на кнопку <b>ОК</b> для удаления  пользователя из системы. После удаления у вас будет возможность переназначить ответственных для записей, принадлежащих удаленному пользователю.',
...
'LBL_DELETE_USER_CONFIRM__' => 'When the User record is deleted, the corresponding Employee record will also be deleted.<br/><br/>'.
                             'Click OK to delete the User record.', /// дубляж
...
'LBL_ADDRESS' => 'Адрес' ,
'LBL_ADMIN_USER' => 'Системный администратор',
...
'LBL_GENERATE_PASSWORD_BUTTON_TITLE'   => 'Сменить пароль [Alt+G]',
...
'LBL_LOGIN_BUTTON_TITLE' => 'Авторизоваться [Alt+L]' ,
...
'LBL_MAX_TAB_DESCRIPTION' => 'Количество закладок, отображаемых в верхней части окна.',
...
'LBL_NAVIGATION_PARADIGM_DESCRIPTION' => 'Просматривать модули, сгруппированные в закладки по определённым признакам или в виде отдельных закладок для каждого модуля.',
...
'LBL_REMINDER_TEXT' => 'Временной интервал по умолчанию для напоминания о предстоящем телефонном разговоре или встрече.' ,
...
'LBL_SESSION_EXPIRED'     => 'Время сессии истекло, необходимо заново войти в систему.',
...
'LBL_TEST_BUTTON_TITLE' => 'Тестирование [Alt+T]' ,
...
'LBL_RESOURCE_TYPE' => 'Тип',
	...
	'LBL_LAST_ADMIN_NOTICE' => 'Вы выбрали собственную учетную запись. Вы не можете изменить ее тип или статус.',
	'LBL_MAIL_SMTPUSER'	=> 'SMTP-пользователь',
	'LBL_MAIL_SMTPPASS'	=> 'SMTP-пароль',
	'LBL_MAIL_SMTPSERVER' => 'SMTP-сервер',
	'LBL_SMTP_SERVER_HELP' => 'Сервер SMTP может быть использован для отправки исходящей электронной почты. Для использования данного сервера в настройках учетной записи укажите соответствующего пользователя и пароль.',
    'LBL_MISSING_DEFAULT_OUTBOUND_SMTP_SETTINGS' => 'Администратор системы еще не настроил стандартный сервер исходящей почты. Тестовое письмо не может быть отправлено.',
    ...
    'LBL_WIZARD_WELCOME' => '
Нажмите на кнопку <b>Далее</b> для настройки основных параметров системы, таких как:<br /><br />

&bull;&nbsp;Информация о сотруднике.<br />
&bull;&nbsp;Параметры отображения даты, времени, валюты, ФИО.<br />
&bull;&nbsp;Параметры сервера исходящей почты.<br />
<br />',

    'LBL_WIZARD_WELCOME_NOSMTP' => '
Предлагаем вам настроить основные параметры системы.<br /><br />

После нажатия на кнопку <b>Далее</b> вам будет предложено настроить следующие параметры:<br /><br />

&bull;&nbsp;Информацию о сотруднике.<br />
&bull;&nbsp;Параметры отображения даты, времени, валюты, ФИО.<br />
<br />',
    ...
    'LBL_WIZARD_FINISH' => 'Вы можете в любое время настроить параметры собственной учетной записи, нажав на ваше имя в верхней части страницы.<br /><br />Нажмите на кнопку <b>Готово</b> для сохранения параметров и начала работы в системе.<br /><br />За дополнительной информацией вы можете обратиться к следующим ресурсам:<br /><br />
...
<tr><td><img src=include/images/university.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/university" target="_blank"><b>Sugar University</b></a><br>Доступ к учебным материалам.</td></tr>
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
<tr><td><img src=include/images/docs.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/crm/support/documentation/SugarCommunityEdition" target="_blank"><b>Англоязычная документация</b></a><br>Официальная онлайн-документация.</td></tr>
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
<tr><td><img src=include/images/kb.png style="margin-right: 5px;"></td><td><a href="http://kb.sugarcrm.com/" target="_blank"><b>База знаний</b></a><br>  
  Сборник статей, посвященных SugarCRM, а также ответы на часто задаваемые вопросы.</td>
</tr>
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
<tr><td><img src=include/images/wiki.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/wiki" target="_blank"><b>Wiki</b></a><br>Сборник статей, посвященных SugarCRM, а также ответы на часто задаваемые вопросы.</td></tr>
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
<tr><td><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/forums" target="_blank"><b>Форум</b></a><br>Официальный форум, посвященный SugarCRM.</td></tr>
</table>',
