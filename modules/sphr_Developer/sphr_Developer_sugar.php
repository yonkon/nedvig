 ...
 * PLACE ANY CUSTOMIZATIONS IN sphr_Developer
 */

require_once('include/SugarObjects/templates/company/Company.php');

class sphr_Developer_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'sphr_Developer';
	var $object_name = 'sphr_Developer';
	var $table_name = 'sphr_developer';
