...
'LBL_ALT_ADDRESS_STREET_2' => 'Альтернативный адрес улицы 2' ,
'LBL_ALT_ADDRESS_STREET_3' => 'Альтернативный адрес улицы 3' ,
...
'LBL_CONTACT_INFORMATION' => 'Информация о предварительном контакте' ,
...
'LBL_CONVERTLEAD_TITLE' => 'Преобразовать предв. контакт [Alt+V]' ,
...
'MSG_DUPLICATE' => 'Найдены одинаковые предварительные контакты. Пожалуйста, отметьте те предварительные контакты, которые Вы хотите связать с записью, создаваемой в результате конвертации. По окончании нажмите кнопку "Далее".' ,
...
'LBL_SERVER_IS_CURRENTLY_UNAVAILABLE' =>'Извините, но в данный момент сервер недоступен. Попробуйте еще раз немного позже.',
