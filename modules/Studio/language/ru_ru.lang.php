...
'LBL_MB_WELCOME'=> '<h2>История</h2><br> История позволяет вам просмотреть предыдущие сохраненные версии редактируемого в данный момент файла. Вы можете сравнить текущую версию с предыдущей, а так же восстановить предыдущую версию. Восстановленный файл станет вашим рабочим файлом. Вы должны опубликовать его для того, чтобы он стал доступен всем пользователям.<br> Что бы вы хотели сделать?<br><b> Пожалуйста, выберите необходимую опцию.</b>',
...
'LBL_RENAME_TAB_WELCOME'=>' Нажмите на необходимом названии закладки для ее переименования.',
...
'LBL_LISTVIEWP_DESCRIPTION'=>'Перед вами две колонки: в первой расположены отображаемые поля, во второй - поля, доступные для отображения. Вы можете перемещать поля между колонками. Вы так же можете изменять порядок расположения полей внутри каждой колонки путем их перемещения.',
